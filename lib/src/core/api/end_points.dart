class EndPoints {
  static const String baseUrl = 'https://166.1.227.210:7014/api/';
  ...
  static const String user = '${baseUrl}Student/';
  static const String loginUser = '${baseUrl}Student/login';
  static const String loginDriver = '${baseUrl}BusDriver/login';
   static const String loginAdmin = '${baseUrl}Admin/login';
   static const String addBooking = '${baseUrl}Booking/create';
  static const String signupUser = '${baseUrl}Student/create';
