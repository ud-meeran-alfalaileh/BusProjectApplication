...
import 'package:drive_app/src/feature/profile/contorller/user_profile_controller.dart';
...
class UserProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(UserProfileController())..getUserProfile();
    User user = User();
    return Scaffold(
                            ...
                            child: Column(
                              ...
                              children: [
                                ProfileText.mainText(
                                    "${"Name".tr}: ${controller.studentProfile.value!.name}"),
                                10.0.kH,
                                ProfileText.secText(
                                    "${"Email".tr}: ${controller.studentProfile.value!.email}"),
                                10.0.kH,
                                Row(
                                  children: [
                                    controller.studentProfile.value!.gender ==
                                            "male"
                                        ? Icon(
                                            Icons.male,
                                            color:
                                    ...
                                    5.0.kW,
                                    ProfileText.secText(
                                        "${"Gender".tr}: ${controller.studentProfile.value!.gender.tr}"),
                                  ],
                                ),
                                10.0.kH,
                              ],
